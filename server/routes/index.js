...
module.exports = (passport) => {
  ...
  router.get("/checkLoggedIn", auth.checkLogin);
  // form routes
  router.post("/createForm", auth.ensure, auth.access, forms.createForm);
  router.post("/updateForm", auth.ensure, auth.access, forms.updateForm);
