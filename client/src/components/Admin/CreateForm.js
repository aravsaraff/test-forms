			...
			<div className='main-container'>
				<div className='created-form'>
					<div className='created-form-meta'>
						<div>ID: {this.state.id}<br/></div>
						<div>Title: {this.state.title}<br/></div>
						<div>Description: {this.state.description}<br/></div>
						<div>Postive: {this.state.positive}<br/></div>
						<div>Negative: {this.state.negative}<br/></div>
						<div>Start: {this.state.start?.toString()}<br/></div>
						<div>End: {this.state.end?.toString()}<br/></div>
					</div>
										...
										<li>
											<form id='single-form' onSubmit={(e) => this.editSingle(e, idx)}>
												...
												<div>
													...
													<button onClick={() => this.deleteField(idx)} style={{color: 'red'}}>Delete</button>
												</div>
											</form>
										</li>
									)
				...
				<div className='form-fields'>
					...
					<button onClick={this.createForm} className='create-button'> Create Form </button>
				</div>
